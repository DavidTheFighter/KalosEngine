...
#define D3D12_HLSL_STORAGE_BUFFER_PREPROCESSOR "#define StorageBufferBinding(TYPE, NAME, BINDING, SET) TYPE NAME : register(__D3D12_MERGE(u, BINDING), __D3D12_MERGE(space, SET))"
#define D3D12_HLSL_STORAGE_TEXTURE_PREPROCESSOR "#define StorageTextureBinding(TYPE, NAME, BINDING, SET) TYPE NAME : register(__D3D12_MERGE(u1, BINDING), __D3D12_MERGE(space, SET))"
