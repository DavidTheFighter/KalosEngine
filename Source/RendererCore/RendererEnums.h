...
typedef enum ResourceBarrierType
{
	RESOURCE_BARRIER_TYPE_TEXTURE_TRANSITION = 0,
	RESOURCE_BARRIER_TYPE_BUFFER_TRANSITION = 1,
	RESOURCE_BARRIER_TYPE_MAX_ENUM = 0x7FFFFFFF
} ResourceBarrierType;
...
typedef enum DescriptorType
{
	...
	DESCRIPTOR_TYPE_SAMPLED_TEXTURE = 2,
	DESCRIPTOR_TYPE_STORAGE_TEXTURE = 3,
	//DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER = 4,
	//DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER = 5,
	DESCRIPTOR_TYPE_CONSTANT_BUFFER = 6,
...
typedef enum BufferUsageFlagBits
{
	...
	BUFFER_USAGE_CONSTANT_BUFFER_BIT = 0x00000010,
...
typedef enum BufferLayout
{
	BUFFER_LAYOUT_VERTEX_BUFFER = 0,
	BUFFER_LAYOUT_INDEX_BUFFER = 1,
	BUFFER_LAYOUT_CONSTANT_BUFFER = 2,
	BUFFER_LAYOUT_VERTEX_CONSTANT_BUFFER = 3,
	BUFFER_LAYOUT_VERTEX_INDEX_BUFFER = 4,
	BUFFER_LAYOUT_VERTEX_INDEX_CONSTANT_BUFFER = 5,
	BUFFER_LAYOUT_GENERAL = 6,
	BUFFER_LAYOUT_INDIRECT_BUFFER = 7,
	BUFFER_LAYOUT_TRANSFER_SRC_OPTIMAL = 8,
	BUFFER_LAYOUT_TRANSFER_DST_OPTIMAL = 9,
	BUFFER_LAYOUT_MAX_ENUM = 0x7FFFFFFF
} BufferLayout;

typedef enum TextureLayout
{
	TEXTURE_LAYOUT_INITIAL_STATE = 0,
	...
	TEXTURE_LAYOUT_RESOLVE_SRC_OPTIMAL = 9,
	TEXTURE_LAYOUT_RESOLVE_DST_OPTIMAL = 10,
...
inline float getResourceFormatBytesPerElement(ResourceFormat format)
{
	switch (format)
	{
