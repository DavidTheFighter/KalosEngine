...
#define VK_HLSL_SAMPLED_TEXTURE_PREPROCESSOR "\"TextureBinding(TYPE, NAME, BINDING, SET)\"=\"[[vk::binding(BINDING + " STRINGIZE(HLSL_SPV_SAMPLED_TEXTURE_OFFSET) ", SET)]] TYPE NAME\""
