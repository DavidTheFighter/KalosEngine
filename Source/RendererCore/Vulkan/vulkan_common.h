...
#define VK_HLSL_STORAGE_BUFFER_PREPROCESSOR "\"StorageBufferBinding(TYPE, NAME, BINDING, SET)\"=\"[[vk::binding(BINDING + " STRINGIZE(HLSL_SPV_STORAGE_BUFFER_OFFSET) ", SET)]] TYPE NAME\""
