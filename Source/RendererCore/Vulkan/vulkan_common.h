...
#define HLSL_SPV_SAMPLED_TEXTURE_OFFSET (HLSL_SPV_INPUT_ATTACHMENT_OFFSET + HLSL_MAX_INPUT_ATTACHMENT_COUNT)
...
#define VK_HLSL_SAMPLER_PREPROCESSOR "\"Sampler(TYPE, NAME, BINDING, SET)\"=\"[[vk::binding(BINDING + " STRINGIZE(HLSL_SPV_SAMPLER_OFFSET) ", SET)]] TYPE NAME\""
#define VK_HLSL_CBUFFER_PREPROCESSOR "\"CBuffer(TYPE, NAME, BINDING, SET)\"=\"[[vk::binding(BINDING + " STRINGIZE(HLSL_SPV_CONSTANT_BUFFER_OFFSET) ", SET)]] TYPE NAME\""
#define VK_HLSL_INPUT_ATTACHMENT_PREPROCESSOR "\"InputAttachment(TYPE, NAME, INDEX, SET)\"=\"[[vk::input_attachment_index(INDEX)]] [[vk::binding(INDEX + " STRINGIZE(HLSL_SPV_INPUT_ATTACHMENT_OFFSET) ", SET)]] TYPE NAME\""
#define VK_HLSL_SAMPLED_TEXTURE_PREPROCESSOR "\"SampledTexture(TYPE, NAME, BINDING, SET)\"=\"[[vk::binding(BINDING + " STRINGIZE(HLSL_SPV_SAMPLED_TEXTURE_OFFSET) ", SET)]] TYPE NAME\""
